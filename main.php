<?php
    ...
    $format = $requestArray[1][1];

    // Run the code for the SQL select statement. Later, we'll want to add
    // logic here to determine which SQL statement is being run instead of just
    // assuming SELECT
    include("select.php");
