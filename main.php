...
// Split the second item in the array to separate the table name from the filetype (There's probably a better way to do this)
...
// Run the code for the SQL select statement. Later, we'll want to add logic here to determine which SQL statement is being run instead of just assuming SELECT.
include("select.php");
